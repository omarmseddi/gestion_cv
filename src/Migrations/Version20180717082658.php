 ...
 */
final class Version20180717082658 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD random_id VARCHAR(255) NOT NULL, ADD redirect_uris LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', ADD secret VARCHAR(255) NOT NULL, ADD allowed_grant_types LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client DROP random_id, DROP redirect_uris, DROP secret, DROP allowed_grant_types');
    }
}
